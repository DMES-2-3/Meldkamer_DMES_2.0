...
--
-- Host: mysql_db
-- Gegenereerd op: 30 mrt 2026 om 15:25
-- Serverversie: 8.0.44
-- PHP-versie: 8.3.26
...
CREATE TABLE IF NOT EXISTS `Logbook` (
  ...
  KEY `IDX_26D6AA8CDB283295` (`FK_notification`)
...
--
-- Beperkingen voor tabel `Logbook`
--
ALTER TABLE `Logbook`
  ADD CONSTRAINT `FK_26D6AA8CDB283295` FOREIGN KEY (`FK_notification`) REFERENCES `Notification` (`notificationId`) ON DELETE CASCADE;
